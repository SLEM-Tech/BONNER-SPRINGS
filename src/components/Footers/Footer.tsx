...
const Footer = () => {
  ...
  const footer1socialMediaIcons = [
    {
      ...
      link: "http://facebook.com/bonny-springs/",
    ...
    // },
    {
      ...
      link: "http://instagram.com/bonny-springs/",
  ...
  return (
    <footer className="bg-primaryColor-100 w-full py-2 flex flex-col item-center ">
