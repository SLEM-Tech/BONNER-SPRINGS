...
import BonnerSpringsPolicies from "./_components/BonnerSpringPolicy";
            ...
            <button
              className={`px-2 xl:px-4 py-2 rounded-md ${
                activeTab === "termsOfUse"
                  ? "bg-primaryColor-100/50 text-white"
        ...
        <div className="flex mx-auto w-full mt-4 md:mt-8 text-base leading-[155%] px-2 sm:px-0 sm:max-w-xl slg:max-w-2xl pb-20">
          {activeTab === "termsOfUse" && (
            <div id="termsOfUse" className="text-[#667085]">
              <h4 className="text-base sm:text-xl xl:text-2xl font-semibold text-white capitalize">
                Terms of Use
              </h4>
          ...
          {activeTab === "privacyPolicy" && (
            <div id="privacyPolicy" className="text-[#667085]">
              <h4 className="text-sm sm:text-xl xl:text-2xl font-semibold text-white">
