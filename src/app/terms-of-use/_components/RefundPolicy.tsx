  ...
  return (
    <div className="text-[#667085]">
      <h3 className="font-semibold text-sm md:text-base xl:text-lg mb-2">
        REFUND POLICY OF BONNER SPRINGS SERVICE LIMITED LIMITED
      </h3>
      ...
      <p className="text-xs md:text-sm xl:text-base mb-4">
        Customer satisfaction is our priority in Bonner Springs Service Limited.
        This Refund Policy explains how we handle returns and refunds for
        purchases made through our e-commerce platform, with payments processed
        by any of our payment facilitators.
      </p>
