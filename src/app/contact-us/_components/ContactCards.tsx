  ...
  const contactCardData = [
    {
      ...
      title: "Email Us",
      type: "email",
      icon: <RxEnvelopeClosed className="text-white text-2xl xl:text-4xl" />,
      additionalText: GeneralSettings ? GeneralSettings[0]?.value : "N/A",
    },
    {
      id: 2,
      title: "Call Us",
      icon: <FiPhoneCall className="text-white text-2xl xl:text-4xl" />,
      type: "tel",
    ...
    },
    {
      ...
      title: "Location",
      type: "text",
      icon: <IoLocationOutline className="text-white text-2xl xl:text-4xl" />,
